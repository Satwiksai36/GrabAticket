-- Migration: Fresh Portable Schema for GrabAticket
-- Created At: 2026-06-09
-- Description: Creates clean movie, theatre, show, booking, profile, and food ordering schema decoupled from auth tables.
...
CREATE TABLE IF NOT EXISTS public.seat_layouts (
    ...
    name TEXT NOT NULL,
    type TEXT NOT NULL DEFAULT 'theatre',
...
-- Create profiles (Decoupled from direct references to auth.users)
...
-- Create bookings (Decoupled from direct references to auth.users)
